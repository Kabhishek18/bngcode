...
function onSuccess(data) {
  ...
  if(JSON.parse(data)){
    ...
    <div class="b-title-error f-title-error"> <strong class="f-primary-l"> No Result Found !</strong> </div>
    <div class="b-error-description f-error-description"> <strong class="f-primary">Sorry, Try using different subcategory </strong> <span class="f-primary">The link you clicked might be corrupted, or the product may have<br> been removed.</span> </div>
