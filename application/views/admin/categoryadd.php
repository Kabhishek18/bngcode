                                        ...
                                        <?php }?>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" name="category_slug" class="form-control" placeholder="Category Name" required data-validation-required-message="This Course Name field is required" value="<?=(!empty($datalist['category_slug'])?$datalist['category_slug']:'')?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <img src="<?=base_url()?>uploads/admin/cat/<?=$product_image?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                 <div class="col-sm-12">
                                                   ...
                                                   <textarea name="category_meta" contenteditable="true">
                                                    <?=(!empty($datalist['category_meta'])?$datalist['category_meta']:'')?>
                                                   </textarea>
                                                    </div>
                                                </div>
                                                   ...
                                                   <script>
                                                        CKEDITOR.replace('category_meta');
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Vendor Status Active/Inactive  </label>
